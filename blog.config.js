...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '创探视界', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个业余数码爱好者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.ctsj.cloudns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '创探视界, 博客', // 网站关键词 英文逗号隔开
